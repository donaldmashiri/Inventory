...
<head>
    ...
    <title>{{ config('app.name', 'PURCHASE ORDER PROCESSING') }}</title>
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-success text-white shadow-sm">
            <div class="container">
                <a class="navbar-brand text-white" href="{{ url('/') }}">
                    <img src="{{asset('images/logo.jpg')}}" width="40" class="rounded" alt="">
                    {{ config('app.name', 'PURCHASE ORDER PROCESSING') }}
                </a>
